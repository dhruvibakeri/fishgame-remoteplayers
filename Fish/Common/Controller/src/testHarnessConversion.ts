 ...
 */
const gameDescriptionPlayerToTournamentPlayer = (
...
const gameDescriptionPlayersReducer = (
  ...
  acc.andThen((accPlayers: Array<TournamentPlayer>) =>
    gameDescriptionPlayerToTournamentPlayer(
      gameDescriptionPlayer
    ).map((tournamentPlayer: TournamentPlayer) => [
      ...accPlayers,
      tournamentPlayer,
    ])
  );
...
const gameDescriptionPlayersToTournamentPlayers = (
  ...
  gameDescriptionPlayers.reduce<Result<Array<TournamentPlayer>, Error>>(
    gameDescriptionPlayersReducer,
    ok([])
  );
 ...
 */
const tournamentPlayerNameToGameDescriptionName = (tpName: string): string =>
  tpName.split("_")[0];
