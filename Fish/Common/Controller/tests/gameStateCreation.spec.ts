...
describe("stateModification", () => {
  ...
  describe("createGameState", () => {
    ...
    it("rejects an empty list of players", () => {
      ...
      expect(
        createGameState(players, playerToColorMapping3Players, board)
      ).toEqual(new InvalidNumberOfPlayersError(players.length));
    });
    ...
    it("successfully creates a Game state with a number of players equal to the maximum", () => {
      ...
      expect(
        createGameState(players, playerToColorMapping4Players, board)
